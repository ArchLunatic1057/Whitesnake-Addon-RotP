...
public class WhitesnakeModel extends HumanoidStandModel<WhitesnakeEntity> {
	...
	protected void initActionPoses() {
		...
		/*ModelPose<WhitesnakeEntity> removeDiscPose1 = new ModelPose<>(new RotationAngle[] {
		...
		ModelPose<WhitesnakeEntity> removeDiscPose2 = new ModelPose<>(new RotationAngle[] {
		...
		ModelPose<WhitesnakeEntity> removeDiscPose3 = new ModelPose<>(new RotationAngle[] {
		...
		actionAnim.put(WhitesnakeRemoveStandDisc.REMOVE_DISC, new PosedActionAnimation.Builder<WhitesnakeEntity>()
				...
				.addPose(StandEntityAction.Phase.PERFORM, new ModelPoseTransitionMultiple.Builder<>(removeDiscPose2)
						.addPose(0.5F, removeDiscPose3)
						.build(removeDiscPose3))
				.addPose(StandEntityAction.Phase.RECOVERY, new ModelPoseTransitionMultiple.Builder<>(removeDiscPose3)
						.addPose(0.5F, removeDiscPose3)
						.build(idlePose))
				.build(idlePose));*/
//----
